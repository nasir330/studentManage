...
<body>
    Dear {{ $user->students->firstName. ' '.$user->students->lastName }},

    <p>
        Account has been created as an <strong>Student</strong> for you.
    </p>
    <p>
    ...
    <p>
        <button style="width:25%; padding:10px; background-color:#222; border-radius:5px 5px 5px 5px;"><a
                ...
                href="{{route('main')}}">Get Started</a></button>
    </p>
    <p>
    ...
    <p>
        Best regards, <br>
        <em>Author</em> <br>
        <strong>Students Manage System</strong>
    </p>
</body>
