                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-2">
                                                    <textarea name="councilorComments" rows="3" class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="managerComment" class="mb-0">Manager's Comments</label>
                                                <div class="input-group mb-2">
                                                    <textarea name="managerComment" rows="3" class="form-control"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-md-9">
                                                <label for="photo" class="mb-0">Documents</label>
                                                <div class="input-group mb-2">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-md-12">
                                                <label for="academicQualification" class="mb-0">Write down into the
                                                    box..</label>
                                                <div class="input-group mb-2">
                                                    <textarea name="academicQualification" rows="3" class="form-control"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-2">
                                                    <select id="epGroup" name="epGroup"
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group mb-2">
                                                    <textarea name="workExperience" rows="3" class="form-control"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group mb-2">
                                                    <textarea name="paymentDescription" rows="3" class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-2">
                                                    <input type="date" name="remindDate" class="form-control"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group mb-2">
                                                    <select name="weightage" class="form-select form-control"
                                                        required>
                                                        <option value="">--Select--</option>
